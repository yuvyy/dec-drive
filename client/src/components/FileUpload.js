    ...
    if (file) {
      try {
        ...
        const resFile = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `612bd7e80daaa562e729`,
            pinata_secret_api_key: `573238279ef9a3268a13ec34e667c9a4b374bd382dd8518eac3009be14d2781b`,
            "Content-Type": "multipart/form-data",
          },
        });
        console.log(fileName);
        const ImgHash = `https://gateway.pinata.cloud/ipfs/${resFile.data.IpfsHash}`;
        contract.add(account,fileName,ImgHash);
